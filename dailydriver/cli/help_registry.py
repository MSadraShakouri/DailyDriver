...
HELP: dict[str, HelpEntry] = {
    ...
    "targets": HelpEntry(
        ...
        usage=[
            ...
            "<kind> log <name> <n> [-n] log progress (-n / --no-last to skip last_action)",
        ...
        notes="Creation and editing happen inside the interactive manager. Use -n / --no-last to log without updating last_action.",
    ),
