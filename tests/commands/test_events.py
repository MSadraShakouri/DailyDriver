...
class TestEventCommands(unittest.TestCase):
    ...
    # ---------- log_event_end ----------
    @patch("dailydriver.features.events._logic.get_pending_start")
    @patch("dailydriver.features.events._logic.log_free_text")
    ...
    @patch("dailydriver.features.events._logic.get_pending_start")
    @patch("dailydriver.features.events._logic.log_free_text")
    @patch("dailydriver.features.events._logic.clear_pending_start")
    ...
    # ---------- log_chain_now ----------
    @patch("dailydriver.features.events._logic.get_last_action_time")
    @patch("dailydriver.features.events._logic.log_free_text")
    @patch("dailydriver.features.events._logic.current_ui")
    ...
    # ---------- start_great_event_cmd ----------
    @patch("dailydriver.features.events._logic.get_active_great_event")
    @patch("dailydriver.features.events._logic.start_great_event")
    @patch("dailydriver.features.events._logic.current_ui")
    ...
    @patch("dailydriver.features.events._logic.get_active_great_event")
    @patch("dailydriver.features.events._logic.log_free_text")
    @patch("dailydriver.features.events._logic.clear_great_event")
    @patch("dailydriver.features.events._logic.current_ui")
