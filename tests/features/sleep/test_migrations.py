...
def test_migration_removes_unique_date_constraint_without_losing_rows():
    ...
    connection.execute("""CREATE TABLE sleep_logs (
    ...
    connection.execute("INSERT INTO sleep_logs (jalali_date, duration_minutes) VALUES ('1405-06-01', 60)")
    migrations()[0](connection)
    connection.execute("INSERT INTO sleep_logs (jalali_date, duration_minutes) VALUES ('1405-06-01', 30)")
