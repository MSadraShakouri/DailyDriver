...
class TestMultiLineBlock(unittest.TestCase):
    ...
    @patch("dailydriver.features.events.commands.end_great_event_cmd")
    @patch("dailydriver.features.events.commands.log_event_end")
    @patch("dailydriver.features.events.commands.log_chain_now")
