...
from dailydriver.features.events.header import (
    get_great_event_str,
    get_last_entry_time,
...
class TestEvents(unittest.TestCase):
    @patch("dailydriver.features.events.header.get_active_great_event")
    ...
    @patch("dailydriver.features.events.header.get_pending_start")
    ...
    @patch("dailydriver.features.events.header.get_last_action_time")
