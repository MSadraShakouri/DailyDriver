...
class TestPrayerNudges(unittest.TestCase):
    def setUp(self):
        ...
        self.conn.execute('CREATE TABLE prayer_logs (id INTEGER PRIMARY KEY, prayer_slot TEXT, jalali_date TEXT, prayer_time INTEGER, status TEXT)')
    ...
    def test_overdue_today(self):
        ...
        nudges = get_prayer_nudges(self.conn, self.target_date, self.today_str,
                                   is_today=True, now=fixed_now)
